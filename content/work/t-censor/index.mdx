...
## What it is
<p class="bigText"> I built and published a browser extension that used facial recognition to locate every instance of the Internet's most offensive face and name, on any site, and pixellate them out — just as TV news would do to something vulgar and unairable. Users could also see a count of how many times they had been spared seeing the face or reading the name.</p>
...
- How awful the web has become when scripts are disabled
- The limit of my endurance for repeatedly proving that I am Not A Robot
...
- In the runup to every election, I'd replace the pixellation effect with an image reading “VOTE” and the number of days until the election