...
<figure>
      <FlexContainer breakpoint="768px">
            <GatsbyImage image={imageByName(props, 'site-iq-ui-0')} alt="" objectFit='contain'  className="shadow"/>
            <GatsbyImage image={imageByName(props, 'site-iq-ui-1')} alt="" objectFit='contain'  className="shadow"/>
            <GatsbyImage image={imageByName(props, 'site-iq-ui-2')} alt="" objectFit='contain'  className="shadow"/>
      </FlexContainer>
...
<figure>
<GatsbyImage style={{maxHeight:rhythm(30)}} imgStyle={{objectFit:'contain'}} image={imageByName(props, 'landing-page', true)} alt="The marketing website I designed for Site IQ."  className="shadow"/>
