...
<figure style="text-align: center">
      <img src='./brand-research.gif' style="margin-bottom: 0; max-height:18em;" className="shadow"/>
...
<figure style="text-align: center">
      <img src='./cre-tech-build.gif' style="margin-bottom: 0; max-height:18em;" className="shadow"/>
...
<figure>
      <GatsbyImage className="shadow" image={imageByName(props, 'posters0', true)} alt="" />
      <GatsbyImage className="shadow" image={imageByName(props, 'posters1', true)} alt="" />
...
>
      <Slider classNameTray="center">
            <Slide index={0}>
                  ...
                  <figcaption>Animation by <a href="https://www.terrahenderson.com" target="_blank">Terra Henderson.</a></figcaption>
            </Slide>
            <Slide index={1}>
                  <GatsbyImage className="shadow" image={imageByName(props, 'style-guide')} alt="Pages from the Build brand style guide."/>
            </Slide>
            <Slide index={2}>
                  <video loop autoplay playsinline muted width="100%">
