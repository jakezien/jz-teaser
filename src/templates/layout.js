...
import { imageByName } from "../utils/functions";
...
const Layout = withTheme((props) => {
  ...
  const shortcodes = { TagList, Section, Link, Inset, GatsbyImage, StaticImage, getImage, FlexContainer, WidthBleeder, CarouselProvider, Slider, Slide, ButtonBack, ButtonNext, DotGroup, imageByName }
