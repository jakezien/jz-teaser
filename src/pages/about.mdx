...
export const query = graphql`
  query {
    jakey: file(relativePath: { regex: "/jakey/i" }) {
      childImageSharp {
        fluid(maxWidth: 1000) {
...
<Img 
  fluid={{ ...props.data.jakey.childImageSharp.fluid, aspectRatio:0.75}} 
  style={{float:"right", marginLeft:rhythm(2), marginBottom:rhythm(2), width:"50%"}}
  />

# About

## Who I am 
I’m Jake Zien, a person living on a mossy rock floating in nothing.x
interested in people, perception, interested in people the world we’ve invented for ourselves, why it is how it is. I'm interested in how meaning is made, how our tools affect our communication and visa versa.
